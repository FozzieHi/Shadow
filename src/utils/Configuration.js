class Configuration {
    constructor() {
        ...
        this.regexes = {
            antiad: /(https?:\/\/)?(www\.)?(discord\.(gg|io|me|li)|discordapp\.com\/invite|discord\.com\/invite|dicksword\.com\/invite|discordservers\.com\/server|top\.gg\/server|shdw\.cc\/i)\/.+[a-zA-Z]/,
            invite: /^[a-zA-Z]{8}$/
        };
