...
class Slowmode extends patron.Command {
    ...
    async run(msg, args) {
        if (args.seconds === 'off' || args.seconds === 'disable' || args.seconds === '0') {
            ...
            return LoggingService.log(msg.dbGuild, msg.guild, Configuration.lightOrangeColour, msg.author, 'Disabled slowmode in ' + msg.channel + '.');
            ...
            return LoggingService.log(msg.dbGuild, msg.guild, Configuration.lightOrangeColour, msg.author, 'Enabled slowmode in ' + msg.channel + ' for ' + args.seconds + ' seconds.');
        } else {
